          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.prev = 0;
                _context2.next = 3;
                return _bookings["default"].findABooking(req.params.id);

              case 3:
                foundBooking = _context2.sent;
                _context2.prev = 4;
                (0, _a.verifyUser)(req.user, foundBooking.user_id);
                _context2.next = 11;
                break;
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _context4.prev = 0;
                _context4.next = 3;
                return _bookings["default"].deleteBooking(req.params.id, req.user);
        ...
        return _regenerator["default"].wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                if (parseInt(req.body.seatNumber, 10)) {
                  _context5.next = 2;
                  break;
                }
              ...
              case 10:
                _context5.prev = 10;
                (0, _a.verifyUser)(req.user, bookingToUpdate.user_id);
