          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return _trips["default"].createTrip(req.body);
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.prev = 0;
                _context2.next = 3;
                return _trips["default"].findTrip(req.params.id);
        ...
        return _regenerator["default"].wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 3:
                allTrips = _context3.sent;

                if (Object.keys(req.query).length > 0 && allTrips.length > 0) {
                  allTrips = _trips["default"].filterTrips(req.query, allTrips);
                }
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _context4.prev = 0;
                _context4.next = 3;
                return _trips["default"].updateTripStatus(req.params.id);
