...
var _a = require("../helperFunctions/a");
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 3:
                ...
                return _context.abrupt("return", res.header('x-access-token', newUser.token).status(201).json({
                  status: 'success',
                  data: {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 5:
                _context2.prev = 5;
                _context2.next = 8;
                return (0, _a.verifyPassword)(req.body.password, user.password);
              ...
              case 15:
                ...
                return _context2.abrupt("return", res.header('x-access-token', token).status(200).json({
                  status: 'success',
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.prev = 0;
                _context3.next = 3;
                return _users["default"].getUserById(req.user, req.params.id);
