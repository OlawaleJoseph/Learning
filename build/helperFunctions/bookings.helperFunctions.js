...
var _trips = _interopRequireDefault(require("./trips.helperFunctions"));
...
function () {
  ...
  (0, _createClass2["default"])(Booking, null, [{
    key: "createBooking",
    value: function () {
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _context4.prev = 0;
                _context4.next = 3;
                return Booking.findABooking(id);
              ...
              case 6:
                (0, _a.verifyUser)(user, bookingToDelete.user_id);
