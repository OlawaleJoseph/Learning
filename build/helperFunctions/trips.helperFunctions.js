  ...
  (0, _createClass2["default"])(TripHelperFunctions, null, [{
    ...
    value: function () {
      ...
      _regenerator["default"].mark(function _callee(body) {
        var bus_id, origin, destination, trip_date, fare, trip, bus, newTripQuery, createdTrip, _createdTrip$, trip_completed, _trip;
        ...
        return _regenerator["default"].wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 8:
                _context.next = 10;
                return TripHelperFunctions.pickBus();

              case 10:
                bus_id = _context.sent;
                trip = TripHelperFunctions.generateTrip();
                origin = trip.origin;
              ...
              case 28:
                _createdTrip$ = createdTrip[0], trip_completed = _createdTrip$.trip_completed, _trip = (0, _objectWithoutProperties2["default"])(_createdTrip$, ["trip_completed"]);
                return _context.abrupt("return", _trip);
    ...
    value: function generateTrip() {
      ...
      var tripNumber = Math.floor(Math.random() * trips.length);
