...
exports.validateTrip = exports.validateQuery = exports.validateBooking = exports.validateParam = exports.validateBus = exports.validateLogin = exports.validateSignUp = void 0;
...
function () {
  ...
  return function validateBus(_x7, _x8, _x9) {
...
var errorMessage = function errorMessage(path) {
  ...
  return new Error("Invalid ".concat(msg, " id"));
};
...
function () {
        ...
        switch (_context4.prev = _context4.next) {
          ...
          case 2:
            schema = _joi["default"].object().keys({
              id: _joi["default"].number().integer().positive().required().error(errorMessage(req.baseUrl))
            });
            _context4.prev = 3;
            _context4.next = 6;
            return _joi["default"].validate(req.params, schema);
  ...
  return function validateParam(_x10, _x11, _x12) {
...
function () {
  ...
  return function validateBooking(_x13, _x14, _x15) {
...
function () {
  ...
  return function validateTrip(_x19, _x20, _x21) {
