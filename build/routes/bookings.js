...
router.get('/:bookingId', [_inputValidation.validateParam, _userValidation.validateToken], _bookings["default"].findABooking);
router.get('/', _userValidation.validateToken, _bookings["default"].findAllBookings);
router.patch('/:bookingId', [_inputValidation.validateParam, _userValidation.validateToken], _bookings["default"].updateSeat);
router["delete"]('/:bookingId', [_userValidation.validateToken], _bookings["default"].deleteBooking);
var _default = router;
