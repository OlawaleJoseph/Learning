...
router.get('/:tripId', [_inputValidation.validateParam, _userValidation.validateToken], _trips["default"].findATrip);
router.patch('/:tripId', [_inputValidation.validateParam, _userValidation.validateToken, _userValidation.checkAdmin], _trips["default"].updateTripStatus);
var _default = router;
