...
router.post('/login', [_inputValidation.validateLogin], _users["default"].login);
router.get('/users/:id', [_inputValidation.validateParam, _userValidation.validateToken], _users["default"].findUser);
var _default = router;
