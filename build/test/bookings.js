        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 3;
              return _chai["default"].request(_index["default"]).post('/api/v1/bookings').set('token', user1.token).send(newBooking);
      ...
      return _regenerator["default"].wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              _context4.next = 2;
              return _chai["default"].request(_index["default"]).post('/api/v1/bookings').set('token', user1.token).send({
                trip_id: trip.trip_id
              });
        ...
        while (1) {
          switch (_context7.prev = _context7.next) {
            ...
            case 2:
              ...
              _context7.next = 5;
              return _chai["default"].request(_index["default"]).post('/api/v1/bookings').set('token', user1.token).send(newTrip);
        ...
        while (1) {
          switch (_context8.prev = _context8.next) {
            ...
            case 3:
              ...
              _context8.next = 6;
              return _chai["default"].request(_index["default"]).get("/api/v1/bookings/".concat(newBooking.booking_id)).set('token', user1.token);
      ...
      return _regenerator["default"].wrap(function _callee9$(_context9) {
        while (1) {
          switch (_context9.prev = _context9.next) {
            case 0:
              _context9.next = 2;
              return _chai["default"].request(_index["default"]).get('/api/v1/bookings/k').set('token', user1.token);
        ...
        while (1) {
          switch (_context11.prev = _context11.next) {
            ...
            case 3:
              ...
              _context11.next = 6;
              return _chai["default"].request(_index["default"]).get("/api/v1/bookings/".concat(newBooking.booking_id)).set('token', user2.token);
      ...
      return _regenerator["default"].wrap(function _callee12$(_context12) {
        while (1) {
          switch (_context12.prev = _context12.next) {
            ...
            case 2:
              _context12.next = 4;
              return _chai["default"].request(_index["default"]).get('/api/v1/bookings/90000').set('token', user1.token);
      ...
      return _regenerator["default"].wrap(function _callee13$(_context13) {
        while (1) {
          switch (_context13.prev = _context13.next) {
            ...
            case 4:
              _context13.next = 6;
              return _chai["default"].request(_index["default"]).get('/api/v1/bookings').set('token', admin.token);
        ...
        while (1) {
          switch (_context17.prev = _context17.next) {
            ...
            case 3:
              ...
              _context17.next = 6;
              return _chai["default"].request(_index["default"])["delete"]("/api/v1/bookings/".concat(booking.booking_id)).set('token', user1.token);
        ...
        while (1) {
          switch (_context19.prev = _context19.next) {
            ...
            case 3:
              ...
              _context19.next = 6;
              return _chai["default"].request(_index["default"])["delete"]("/api/v1/bookings/".concat(booking.booking_id)).set('token', user2.token);
