        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 3;
              return _chai["default"].request(_index["default"]).post('/api/v1/buses').set('token', admin.token).send(busData2);
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              _context4.next = 3;
              return _chai["default"].request(_index["default"]).post('/api/v1/buses').set('token', admin.token).send(busData);
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              _context5.next = 3;
              return _chai["default"].request(_index["default"]).post('/api/v1/buses').set('token', admin.token).send(busData3);
      ...
      return _regenerator["default"].wrap(function _callee7$(_context7) {
        while (1) {
          switch (_context7.prev = _context7.next) {
            case 0:
              _context7.next = 2;
              return _chai["default"].request(_index["default"]).get("/api/v1/buses/".concat(newBus.bus_id)).set('token', admin.token);
      ...
      return _regenerator["default"].wrap(function _callee8$(_context8) {
        while (1) {
          switch (_context8.prev = _context8.next) {
            case 0:
              _context8.next = 2;
              return _chai["default"].request(_index["default"]).get('/api/v1/buses/h').set('token', admin.token);
      ...
      return _regenerator["default"].wrap(function _callee9$(_context9) {
        while (1) {
          switch (_context9.prev = _context9.next) {
            case 0:
              _context9.next = 2;
              return _chai["default"].request(_index["default"]).get('/api/v1/buses/1000').set('token', admin.token);
      ...
      return _regenerator["default"].wrap(function _callee11$(_context11) {
        while (1) {
          switch (_context11.prev = _context11.next) {
            case 0:
              _context11.next = 2;
              return _chai["default"].request(_index["default"]).get('/api/v1/buses').set('token', admin.token);
