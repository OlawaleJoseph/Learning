        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 3;
              return _chai["default"].request(_index["default"]).post('/api/v1/buses').set('x-access-token', admin.token).send(busData2);
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              _context4.next = 3;
              return _chai["default"].request(_index["default"]).post('/api/v1/buses').set('x-access-token', admin.token).send(busData);
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              _context5.next = 3;
              return _chai["default"].request(_index["default"]).post('/api/v1/buses').set('x-access-token', admin.token).send(busData3);
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              ...
              _context6.next = 3;
              return _chai["default"].request(_index["default"]).post('/api/v1/buses').set('x-access-token', 'invalidtoken').send(busData4);
      ...
      return _regenerator["default"].wrap(function _callee7$(_context7) {
        while (1) {
          switch (_context7.prev = _context7.next) {
            case 0:
              _context7.next = 2;
              return _chai["default"].request(_index["default"]).get("/api/v1/buses/".concat(newBus.bus_id)).set('x-access-token', admin.token);
      ...
      return _regenerator["default"].wrap(function _callee8$(_context8) {
        while (1) {
          switch (_context8.prev = _context8.next) {
            case 0:
              _context8.next = 2;
              return _chai["default"].request(_index["default"]).get('/api/v1/buses/h').set('x-access-token', admin.token);
      ...
      return _regenerator["default"].wrap(function _callee9$(_context9) {
        while (1) {
          switch (_context9.prev = _context9.next) {
            case 0:
              _context9.next = 2;
              return _chai["default"].request(_index["default"]).get('/api/v1/buses/1000').set('x-access-token', admin.token);
      ...
      return _regenerator["default"].wrap(function _callee10$(_context10) {
        while (1) {
          switch (_context10.prev = _context10.next) {
            case 0:
              _context10.next = 2;
              return _chai["default"].request(_index["default"]).get('/api/v1/buses/g').set('x-access-token', 'token');
      ...
      return _regenerator["default"].wrap(function _callee11$(_context11) {
        while (1) {
          switch (_context11.prev = _context11.next) {
            case 0:
              _context11.next = 2;
              return _chai["default"].request(_index["default"]).get('/api/v1/buses').set('x-access-token', admin.token);
      ...
      return _regenerator["default"].wrap(function _callee12$(_context12) {
        while (1) {
          switch (_context12.prev = _context12.next) {
            case 0:
              _context12.next = 2;
              return _chai["default"].request(_index["default"]).get('/api/v1/buses').set('x-access-token', 'token');
