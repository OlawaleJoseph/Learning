      ...
      return _regenerator["default"].wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              _context3.next = 2;
              return _chai["default"].request(_index["default"]).post('/api/v1/trips').set('token', admin.token).send(tripObj);
      ...
      return _regenerator["default"].wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              _context4.next = 2;
              return _chai["default"].request(_index["default"]).post('/api/v1/trips').set('token', user.token).send(tripObj);
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            ...
            case 2:
              ...
              _context5.next = 5;
              return _chai["default"].request(_index["default"]).post('/api/v1/trips').set('token', admin.token).send(tripObj2);
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              ...
              _context6.next = 3;
              return _chai["default"].request(_index["default"]).post('/api/v1/trips').set('token', admin.token).send(tripObj1);
                ...
                while (1) {
                  switch (_context7.prev = _context7.next) {
                    ...
                    case 2:
                      trip = _context7.sent;
                      _context7.next = 5;
                      return _chai["default"].request(_index["default"]).get("/api/v1/trips/".concat(trip.trip_id)).set('token', user.token);
              ...
              return _regenerator["default"].wrap(function _callee8$(_context8) {
                while (1) {
                  switch (_context8.prev = _context8.next) {
                    case 0:
                      _context8.next = 2;
                      return _chai["default"].request(_index["default"]).get('/api/v1/trips/h').set('token', user.token);
              ...
              return _regenerator["default"].wrap(function _callee9$(_context9) {
                while (1) {
                  switch (_context9.prev = _context9.next) {
                    case 0:
                      _context9.next = 2;
                      return _chai["default"].request(_index["default"]).get('/api/v1/trips/900').set('token', user.token);
      ...
      return _regenerator["default"].wrap(function _callee11$(_context11) {
        while (1) {
          switch (_context11.prev = _context11.next) {
            case 0:
              _context11.next = 2;
              return _chai["default"].request(_index["default"]).get('/api/v1/trips').set('token', user.token);
      ...
      return _regenerator["default"].wrap(function _callee12$(_context12) {
        while (1) {
          switch (_context12.prev = _context12.next) {
            ...
            case 4:
              _context12.next = 6;
              return _chai["default"].request(_index["default"]).get('/api/v1/trips/?origin=yaba').set('token', user.token);
                ...
                while (1) {
                  switch (_context13.prev = _context13.next) {
                    ...
                    case 2:
                      ...
                      _context13.next = 5;
                      return _chai["default"].request(_index["default"]).patch("/api/v1/trips/".concat(newTrip.trip_id)).set('token', admin.token);
                ...
                while (1) {
                  switch (_context14.prev = _context14.next) {
                    ...
                    case 2:
                      ...
                      _context14.next = 5;
                      return _chai["default"].request(_index["default"]).patch("/api/v1/trips/".concat(newTrip.trip_id)).set('token', user.token);
              ...
              return _regenerator["default"].wrap(function _callee15$(_context15) {
                while (1) {
                  switch (_context15.prev = _context15.next) {
                    ...
                    case 2:
                      _context15.next = 4;
                      return _chai["default"].request(_index["default"]).patch('/api/v1/trips/l').set('token', admin.token);
              ...
              return _regenerator["default"].wrap(function _callee16$(_context16) {
                while (1) {
                  switch (_context16.prev = _context16.next) {
                    case 0:
                      _context16.next = 2;
                      return _chai["default"].request(_index["default"]).patch('/api/v1/trips/9000').set('token', admin.token);
