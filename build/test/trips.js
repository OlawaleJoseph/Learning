...
describe('Trips', function () {
  ...
  describe('Create Trips', function () {
      ...
      return _regenerator["default"].wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              _context3.next = 2;
              return _chai["default"].request(_index["default"]).post('/api/v1/trips').set('x-access-token', admin.token).send(tripObj);
    ...
    it('Should create a random trip without any input',
    /*#__PURE__*/
    (0, _asyncToGenerator2["default"])(
    /*#__PURE__*/
      ...
      return _regenerator["default"].wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              _context4.next = 2;
              return _chai["default"].request(_index["default"]).post('/api/v1/trips').set('x-access-token', admin.token).send();
      ...
      return _regenerator["default"].wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              _context5.next = 2;
              return _chai["default"].request(_index["default"]).post('/api/v1/trips').set('x-access-token', user.token).send(tripObj);
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            ...
            case 2:
              ...
              _context6.next = 5;
              return _chai["default"].request(_index["default"]).post('/api/v1/trips').set('x-access-token', admin.token).send(tripObj2);
        ...
        while (1) {
          switch (_context7.prev = _context7.next) {
            case 0:
              ...
              _context7.next = 3;
              return _chai["default"].request(_index["default"]).post('/api/v1/trips').set('x-access-token', admin.token).send(tripObj1);
                ...
                while (1) {
                  switch (_context8.prev = _context8.next) {
                    ...
                    case 2:
                      trip = _context8.sent;
                      _context8.next = 5;
                      return _chai["default"].request(_index["default"]).get("/api/v1/trips/".concat(trip.trip_id)).set('x-access-token', user.token);
              ...
              return _regenerator["default"].wrap(function _callee9$(_context9) {
                while (1) {
                  switch (_context9.prev = _context9.next) {
                    case 0:
                      _context9.next = 2;
                      return _chai["default"].request(_index["default"]).get('/api/v1/trips/h').set('x-access-token', user.token);
              ...
              return _regenerator["default"].wrap(function _callee10$(_context10) {
                while (1) {
                  switch (_context10.prev = _context10.next) {
                    case 0:
                      _context10.next = 2;
                      return _chai["default"].request(_index["default"]).get('/api/v1/trips/900').set('x-access-token', user.token);
      ...
      return _regenerator["default"].wrap(function _callee12$(_context12) {
        while (1) {
          switch (_context12.prev = _context12.next) {
            case 0:
              _context12.next = 2;
              return _chai["default"].request(_index["default"]).get('/api/v1/trips').set('x-access-token', user.token);
      ...
      return _regenerator["default"].wrap(function _callee13$(_context13) {
        while (1) {
          switch (_context13.prev = _context13.next) {
            ...
            case 2:
              _context13.next = 4;
              return _trips["default"].createTrip(trip2Obj);

            case 4:
              _context13.next = 6;
              return _chai["default"].request(_index["default"]).get('/api/v1/trips/?origin=yaba').set('x-access-token', user.token);
                ...
                while (1) {
                  switch (_context14.prev = _context14.next) {
                    ...
                    case 2:
                      ...
                      _context14.next = 5;
                      return _chai["default"].request(_index["default"]).patch("/api/v1/trips/".concat(newTrip.trip_id)).set('x-access-token', admin.token);
              ...
              return _regenerator["default"].wrap(function _callee15$(_context15) {
                while (1) {
                  switch (_context15.prev = _context15.next) {
                    ...
                    case 2:
                      newTrip = _context15.sent;
                      _context15.next = 5;
                      return _chai["default"].request(_index["default"]).patch("/api/v1/trips/".concat(newTrip.trip_id)).set('x-access-token', user.token);
              ...
              return _regenerator["default"].wrap(function _callee16$(_context16) {
                while (1) {
                  switch (_context16.prev = _context16.next) {
                    ...
                    case 2:
                      _context16.next = 4;
                      return _chai["default"].request(_index["default"]).patch('/api/v1/trips/l').set('x-access-token', admin.token);
              ...
              return _regenerator["default"].wrap(function _callee17$(_context17) {
                while (1) {
                  switch (_context17.prev = _context17.next) {
                    case 0:
                      _context17.next = 2;
                      return _chai["default"].request(_index["default"]).patch('/api/v1/trips/9000').set('x-access-token', admin.token);
