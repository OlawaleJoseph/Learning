        ...
        while (1) {
          switch (_context7.prev = _context7.next) {
            case 0:
              ...
              _context7.next = 3;
              return _chai["default"].request(_index["default"]).post('/api/v1/auth/login').send(loginData);
        ...
        while (1) {
          switch (_context8.prev = _context8.next) {
            case 0:
              ...
              _context8.next = 3;
              return _chai["default"].request(_index["default"]).post('/api/v1/auth/login').send(wrongData);
      ...
      return _regenerator["default"].wrap(function _callee11$(_context11) {
        while (1) {
          switch (_context11.prev = _context11.next) {
            case 0:
              _context11.next = 2;
              return _chai["default"].request(_index["default"]).get("/api/v1/auth/users/".concat(user.user_id)).set('x-access-token', user.token);
        ...
        while (1) {
          switch (_context13.prev = _context13.next) {
            ...
            case 3:
              ...
              _context13.next = 6;
              return _chai["default"].request(_index["default"]).get("/api/v1/auth/users/".concat(createdUser.user_id)).set('x-access-token', user.token);
