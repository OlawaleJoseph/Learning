      ...
      return _regenerator["default"].wrap(function _callee11$(_context11) {
        while (1) {
          switch (_context11.prev = _context11.next) {
            case 0:
              _context11.next = 2;
              return _chai["default"].request(_index["default"]).get("/api/v1/auth/users/".concat(user.user_id)).set('token', user.token);
        ...
        while (1) {
          switch (_context13.prev = _context13.next) {
            ...
            case 3:
              ...
              _context13.next = 6;
              return _chai["default"].request(_index["default"]).get("/api/v1/auth/users/".concat(createdUser.user_id)).set('token', user.token);
